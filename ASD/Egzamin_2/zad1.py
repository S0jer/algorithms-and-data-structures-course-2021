...
# Pomysł polega na zapisywaniu przedziałów po których idziemy z i-tego przedziału zaczynającego się w x (sortujemy po poczatkach)
# gdy znajdziemy przedział kończący się w Y łączacy się z naszą dotychczasową trasą to zaznaczyamy użyte przedziały
# jako te 'przydatne' nastepnei z tablicy zawierającej zaznaczone 'przydatne' przedziały odczytujemy ich liste
# i zwracamy jako wynik
