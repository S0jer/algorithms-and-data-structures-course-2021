...
# tak aby możliwe było dotarcie autostradą do każdego miasta. Ponieważ kontynent,
# na którym leży państwo jest płaski położenie każdego z miast opisują dwie liczby x, y, a odległość w linii
...
# Proszę zaimplementować funkcję highway(A), która dla danych położeń miast wyznacza minimalną liczbę
